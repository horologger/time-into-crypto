...
export const getConfig: T.ExpectedExports.getConfig = compat.getConfig({
    ...
    "nostr-relay": {
        ...
        "description": "The Nostr Relay to use for Time Into Crypto connections",
        "copyable": true,
        "nullable": false,    
    },
    "implementation": {
      ...
      "warning": "If you change the LN implementation after using Time Into Crypto this will delete all NWC connections related to the previously configured!",
